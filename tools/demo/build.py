...
os.makedirs(f'{ROOT}/site/public', exist_ok=True)
open(f'{ROOT}/site/public/demo.html', 'w').write(out)
print('wrote site/public/demo.html', len(out) // 1024, 'KB', 'species', len(species))
