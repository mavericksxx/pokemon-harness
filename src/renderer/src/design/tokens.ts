 ...
 * Not colors/type/space, but it's this file's only home for a rule that
 * spans every component, so it lives here rather than nowhere. Exemptions:
 * user-entered content (session titles, workspace
